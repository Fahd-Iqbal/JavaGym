...
CREATE TABLE `trainingschedule` (
  ...
  `dailyWorkoutId` int(11) NOT NULL,
...
LOCK TABLES `trainingschedule` WRITE;
/*!40000 ALTER TABLE `trainingschedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `trainingschedule` ENABLE KEYS */;
UNLOCK TABLES;
